...
public class Round02 : RoundData
{
    public override void Init()
    {
        ...
        {
            new QuestionData(0, QuestionPattern.AAAA, QuestionCategory.Color, QuestionSpriteType.Abstract, FieldType._1x7, FieldType._1x7),
            new QuestionData(1, QuestionPattern.ABAB, QuestionCategory.Color, QuestionSpriteType.Abstract, FieldType._1x7, FieldType._1x7),
            new QuestionData(2, QuestionPattern.AABB, QuestionCategory.Color, QuestionSpriteType.Abstract, FieldType._1x7, FieldType._1x7),
            new QuestionData(3, QuestionPattern.ABC, QuestionCategory.Color, QuestionSpriteType.Abstract, FieldType._3x3, FieldType._1x7),
            new QuestionData(4, QuestionPattern.ABA, QuestionCategory.Color, QuestionSpriteType.Abstract, FieldType._3x3, FieldType._1x7),
        ...
        else if (questionData.index == 2) // AABB Matrix_1x7
        {
            questionBoxDataList = new List<BoxData>
                {
